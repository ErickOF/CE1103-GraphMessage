...
public class Bluetooth extends Activity implements OnClickListener{
    ...
    private InstanciaCliente _instCliente;
    private String address;
    private String nombre;
    private Button _hide;
    private Servidor _server;
    private InstanciaServidor _instServer;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        lvDispositivos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                client = new Cliente(Bluetooth.this,address,nombre,ip);
                _instCliente  = InstanciaCliente.getSingletonInstance(client);
            }
        });
    }
    ...
    public void onClick(View view) {
        switch(view.getId())
        {
            ...
            case R.id.btnVerif:
                Toast.makeText(this, R.string.DetectarBaneo, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void cambiarPantalla(){
        ...
        Intent select = new Intent(this,Selection.class);
        startActivity(select);
        _server = new Servidor(Bluetooth.this);
        _instServer = InstanciaServidor.getSingletonInstance(_server);
    }

    //Este método se utiliza cuando el usuario está baneado
    /*public void mostrarEstado(){
        Button _hides = (Button)findViewById(R.id.btnVerif);
        _hides.setOnClickListener(this);
        _hides.isPressed();
        _hides.isSelected();
        _hides.performClick();
        _hides.setActivated(true);
